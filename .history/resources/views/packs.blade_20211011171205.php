                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="section-tittle text-center mb-80">
                            <span>Nos packs de prix</span>
                            <h2>Pack de prix!</h2>
                            <p>Nous mettons à disposition une variété de pack déja établie, pour un déménagement plus facile!</p>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-cat text-center mb-50">
                            <div class="cat-icon">
                            <span><svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-currency-dollar" viewBox="0 0 16 16">
                            ...
                            <div class="cat-cap">
                                <h2>Economique</h2>
                                <p>Un pack de prix économique qui vous premet de pouvoir déménager à moindre prix tout en ayant de la qualité</p>
                            </div>
                            <div class="cat-cap">
                                <h2>Ce pack contient</h2>
                             
                                <ul>
                                <li>Numéro de pack:</li>
                                <li> 1</li>
                                 ...
                                 <li> 2 personnes</li>
                                 <br>
                                 <li>Nombre d'heure presté:</li>
                                 <li> 2 heures</li>
                                 <br>
                                 <li>Prix du pack économique:</li>
                                 <li>110.00 €</li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-cat text-center mb-50">
                            <div class="cat-icon">
                            <span><svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-bookmark-check" viewBox="0 0 16 16">
                            ...
                            <div class="cat-cap">
                                <h2>Standard</h2>
                                <p>Pack basic le plus apprécié permettant de déménager rapidement et simplement</p>
                            </div>
                            <div class="cat-cap">
                                <h2>Ce pack contient</h2>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-cat text-center mb-50">
                        <h2><a href="{{ route('packsPromo') }}">Promotion</a></h2>
                            <div class="cat-icon">
                            ...
                            <div class="cat-cap">
                                <h2>VIP</h2>
                                <p>Pack pour les plus gros déménagement ! le pack VIP étant le plus optimal que nous pouvons proposer</p>
                            </div>
                            <div class="cat-cap">
                                <h2>Ce pack contient</h2>
