                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form method="POST" action="getMiles">
                                                            ...
                                                            <input type="date" name="startDate" class="form-control " id="startDate"  value= "<?php echo date('Y-m-d'); ?>"    min= "<?php echo date('Y-m-d'); ?>"  max= "2023-01-01">
                                                            </div>
                                                            <div class="form-group">
                                                            <label for="heure" hidden>heure disponible:</label>
