                ...
                <div class="text-center card-box">
                    <div class="member-card pt-2 pb-2">
                        ...
                        <div class="">
                            ...
                            @if($pack->size_truck == 'Large') 
                                 35
                                 @else
                                 45
                                @endif m²
                            <p class="text-muted">@if($admin = 0) @Utilisateur @else @administrateur @endif{{$id}}<span>| </span><span><a href="#" class="text-pink">websitename.com</a></span></p>
                        </div>
