...
class adminController extends Controller
{
  ...
  public function deleteCamion($id)
    ...
    public function dashboard()
    {
      ...
      $dev = Devis::where('user_id','=', $userId)->count(); 
      $devPayer = Devis::where('status','=', 'payer')->where('user_id','=', $userId)->count(); 
      $devisPayer = Devis::where('status','=', 'payer')->count();
    ...
    public function resdetails($id)
    {
        ...
        dd($client);
        $iduser = $client->user_id;
        $users = User::all()->where('id','=', $iduser);
        $user = Auth::user();
        ...
        return view('admin.resdetails')->with([
