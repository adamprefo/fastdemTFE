                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form method="POST" action="getMiles">
                                                            ...
                                                            <input type="datetime-local" name="datetime" class="form-control" id="tripdate"  value= "<?php echo date('Y-m-d'); ?>T:00"    min= "<?php echo date('Y-m-d'); ?>T08:00"  max= "2023-01-01T18:00">
                                                            </div>
