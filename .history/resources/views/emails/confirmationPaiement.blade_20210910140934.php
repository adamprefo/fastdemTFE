...
<span>Bonjour <span>{{$user->name}} {{$user->lastname}}</span>, Nous confirmons que nous avons bien reçu votre paiement sécurisé en ligne. Voici une copie détaillée de votre facture.
   Merci de faire confiance à { company.name }. </span>
