                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form method="POST" action="getMiles">
                                                            ...
                                                            <input type="date" name="datetime" class="form-control" id="tripdate"  value= "<?php echo date('Y-m-d'); ?>"    min= "<?php echo date('Y-m-d'); ?>"  max= "2023-01-01">
                                                            </div>
                                                            <div class="form-group">
                                                            <label for="start">heure disponible:</label>
                                                            <h5 for="heure">Selectionnée votre packs de prix</h5>
