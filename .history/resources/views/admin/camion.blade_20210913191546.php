                                                        ...
                                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <form method="POST" action="admin/camion/add">
                                                                        @csrf
                                                                        <div class="form-group">
                                                                            <label>Nom de la taille du camion</label>
                                                                            <input class="form-control" name="size" require placeholder="Large, Medium, Xl.." id="size">

                                                                        </div>
                                                                        <div class="form-group">
                                                                            <label for="">Taille du camion en m²</label>
                                                                            <input class="form-control" name="mcarrer" require placeholder="m²"  id="mCarrer" />
