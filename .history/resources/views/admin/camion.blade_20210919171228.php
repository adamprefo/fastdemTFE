                                        ...
                                        <tbody class="bg-white divide-y divide-gray-200">
                                            ...
                                            <tr>
                                                ...
                                                <div class="text-center">
                                                    <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                                                        <button type="submit" class="btn btn-danger btn-sm"  onclick="window.location.href='/deleteCamion/{{ $truck->id }}'">
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                                                      ...
                                                      <button type="button" id="btn" class="btn btn btn-success btn-sm  " data-toggle="modal" data-target="#exampleModalCenter">
