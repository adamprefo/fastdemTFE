...
<body>
         ...
         <div class="container">
             <h1>Formulaires</h1>
             <form>
                 <input type="email" readonly class="form-control mb-3" id="email" placeholder="pierre.giraud@edhec.com">
                 <input type="email" readonly class="form-control-plaintext" id="email" placeholder="pierre.giraud@edhec.com">
             </form>
         </div>
    </body>
  ...
  <div class="card__back card__part">
    <div class="card__black-line"></divcontent="width=device-width, initial-scale=1, shrink-to-fit=no">
     </head>
     <body>
         <div class="container">
             <h1>Formulaires</h1>
