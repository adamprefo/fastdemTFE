...
Route::group(['middleware' => 'auth'], function(){
    ...
    Route::get('admin/charts',[AdminController::class,'chartd'])->name('admin.chart');
    ...
    Route::get('deleteCamion/{id}',[AdminController::class,'deleteCamion']);
    Route::get('/admin/delete/{id}',[AdminController::class,'delete']);
    Route::get('/dashboard',[AdminController::class,'dashboard'])->name('dashboard');
    
    Route::get('admin/reservation',[AdminController::class,'reservation'])->name('admin.reservation');
    Route::get('/resdetails/{id}',[AdminController::class,'resdetails']);
