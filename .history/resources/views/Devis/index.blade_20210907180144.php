                                            ...
                                            <tr>
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                                                    <!-- Button trigger modal -->
                                                        ...
                                                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModalCente"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-search" viewBox="0 0 16 16">
