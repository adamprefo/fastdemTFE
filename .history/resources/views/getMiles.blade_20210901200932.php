...
<body>
  ...
  <p class="lead"><strong>Votre devis en ligne à bien été effectuer!</strong>Payer & consulter vos devis pour les payers !</p>
  <hr>
  <p>
     Des questions?<a class="lead href="{{ route('contact') }}">Contactez-nous</a>
  </p>
  <p class="lead">
    <a class="btn btn-primary btn-sm" href="{{ route('devis.index') }}" role="button">Consulter mes devis</a>
  </p>
</div>
