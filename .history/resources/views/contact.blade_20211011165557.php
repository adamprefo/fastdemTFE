...
<body>
    ...
    <main>
        ...
        <div class="slider-area ">
            <div class="single-slider hero-overly slider-height2 d-flex align-items-center" data-background="assets/img/hero/contactus.jpg">
                <div class="container">
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="hero-cap">
        ...
        <!-- slider Area End-->
        <div class="center">
            <h1 class="text-center">Notre adresse ! </h1>
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2518.4134895655848!2d4.407657316414152!3d50.86054437953422!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47c3c34cb831d43f%3A0xcbba123dcb09c3b8!2sAv.%20de%20l&#39;Optimisme%2055%2C%201140%20Evere!5e0!3m2!1sfr!2sbe!4v1633963929495!5m2!1sfr!2sbe"
             width="2700" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
            </div>
                </div>
                <div class="row">
                    <div class="col-12">
                        <h2 class="contact-title">Envoyer un mail pour plus de question</h2>
                    </div>
                    <div class="col-lg-8">
                        <form class="form-contact contact_form" action="contact_process.php" method="post" id="contactForm" novalidate="novalidate">
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        <textarea class="form-control w-100" name="message" id="message" cols="30" rows="9" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter Message'" placeholder="Entre votre message"></textarea>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                    ...
                    <div class="col-lg-3 offset-lg-1">
                        <div class="media contact-info">
                            ...
                            <div class="media-body">
                                <h3>Bruxelles, 1000.</h3>
                                <p>Rue De L'optimisme 55</p>
                            </div>
                        </div>
                        <div class="media contact-info">
                            ...
                            <div class="media-body">
                                <h3>+02.655.45.55</h3>
                                <p>Lun - Samedi 8.00 - 18.00</p>
                            </div>
                        </div>
                        <div class="media contact-info">
                            <span class="contact-info__icon"><i class="ti-email"></i></span>
                            <div class="media-body">
                                <h3>fastdeminfo@gmail.com</h3>
                                <p>Nous contactez à tout moment!</p>
                            </div>
                        </div>
                    </div>
                </div>
