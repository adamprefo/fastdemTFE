...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::post('checkout.succes','send-mail', [CheckoutController::class, 'afterpayment'])->name('checkout.succes');
    ...
    Route::get('send-mail', function () {
        ...
        Mail::to('Fastdem@gmail.com')->send(new \App\Mail\MyTestMail($details));
