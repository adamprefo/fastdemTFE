                ...
                <div class="text-center card-box">
                    <div class="member-card pt-2 pb-2">
                        ...
                        <div class="">
                            ...
                            <p class="text-muted">@if($admin = 0) Utilisateur @else administrateur @endif{{$id}}<span> | </span><span><a href="#" class="text-pink">Fastdem.com</a></span></p>
                        </div>
                        ...
                        <div class="mt-4">
                            <div class="row">
                                <div class="col-4">
                                    <div class="mt-3">
                                        <h4> {{$nbDevis}}</h4>
                                        <p class="mb-0 text-muted">Nombre de @if($admin = 0) mes devis @else total devis créer par les utilisateurs @endif</p>
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="mt-3">
                                        <h4></h4>
                                        <p class="mb-0 text-muted">Nombre de devis payée</p>
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="mt-3">
