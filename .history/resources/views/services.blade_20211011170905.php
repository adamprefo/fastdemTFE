   ...
   <body>
    ...
    <main>
        ...
        <div class="slider-area ">
            <div class="single-slider hero-overly slider-height2 d-flex align-items-center" data-background="assets/img/hero/services.png">
                <div class="container">
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="hero-cap">
                                ...
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="{{ route('services') }}">Nos services</a></li> 
                                    </ol>
                                </nav>
                            </div>
                        </div>
        ...
        <div class="categories-area section-padding30">
            ...
            <div class="section-tittle mb-35">
                                ...
                                <h2>Fastdem Déménagement</h2>
                            </div>
                            <p>Vous recherchez une entreprise de déménagement mais vous n’êtes pas certain de ce qu’elle peut vous offrir ?</p>
                            Cet article détaille pour vous tous les services déménagement et les prestations possibles, afin de faciliter votre emménagement dans votre nouveau logement.
                            <p> Nous vous proposons ici les prix moyens des services offerts par les déménageurs avec une description de chacun de ces services.</p>
      
        <div class="section-tittle mb-35">

                                <h2>Fastdem Sécurité</h2>
                            </div>
                            <p>Il en va de même pour les accès au bien à vider. Il faut s’assurer que le trajet du camion jusqu’à la maison soit libéré et ne contienne aucun obstacle. Si le cœur vous en dit, de même que la motivation, vous pouvez effectuer un parcours fléché indiquant le sens de circulation.<p>

                             Dans le cas où vous devez entreposer des affaires sur le trottoir entre 2 chargements, assurez-vous qu’il y a suffisamment de place autour. 
                             </p>Effectuez une signalétique à destination des piétons. Indiquez par exemple « Déménagement en cours ». Car un homme averti en vaut deux ! Les passants seront ainsi plus vigilants .
                            Et vous éviterez de perdre du temps à discuter avec un piéton mécontent ou qui se serait blessé avec une de vos affaires.<p> Plus de sécurité pour votre déménagement !
                            </p>
        <div class="text-center">

                                <h2>Fastdem Rapidité</h2>
                            </div>
                            <p>Déménager rapidiement grace à Fastdem ! nous vous offrons la posibilité de choisir votre déménagement en ligne et pouvoir le payer!</p>
                            <p>Nous misons beaucoup sur la ponctualité de nos déménagement et donnons notre maximum pour respecter les horaires prévus!</p>
