...
class MilesController extends Controller
{
    public function miles(Request $request){
        ...
        if($km_to_miles > 1000){
            ...
            return Redirect::back()->withErrors(['msg' => 'Une erreur est survenue lors de la création de votre devis en ligne, un maximum de 1000km sont acceptée pour les déménagements']);
