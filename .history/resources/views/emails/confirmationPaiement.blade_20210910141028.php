...
Bonjour <span style="font-weight:bolder">{{$user->name}} {{$user->lastname}}</span>, Nous confirmons que nous avons bien reçu votre paiement sécurisé en ligne. 
Voici une copie détaillée de votre facture.
   Merci de faire confiance à <span  style="font-weight:bolder">{ company.name }. </span>
